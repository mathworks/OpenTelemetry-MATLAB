...
void OtlpHttpMetricExporterProxy::setEndpoint(libmexclass::proxy::method::Context& context) {
...
void OtlpHttpMetricExporterProxy::setFormat(libmexclass::proxy::method::Context& context) {
...
void OtlpHttpMetricExporterProxy::setJsonBytesMapping(libmexclass::proxy::method::Context& context) {
...
void OtlpHttpMetricExporterProxy::setUseJsonName(libmexclass::proxy::method::Context& context) {
    matlab::data::TypedArray<bool> use_json_name_mda = context.inputs[0];
    CppOptions.use_json_name = use_json_name_mda[0];
}

void OtlpHttpMetricExporterProxy::setTimeout(libmexclass::proxy::method::Context& context) {
...
void OtlpHttpMetricExporterProxy::setHttpHeaders(libmexclass::proxy::method::Context& context) {
...
void OtlpHttpMetricExporterProxy::setTemporality(libmexclass::proxy::method::Context& context) {
